...
public class ThemeUtil {
    ...
    public static final int THEME_EMERALD = 19;
    ...
    public static int getThemeId(int theme){
        ...
        switch (theme){
            ...
            case THEME_BLUEGRAY  :
                ...
                break;
            case THEME_EMERALD  :
                themeId = R.style.AppTheme_EMERALD;
                break;
            default:
                break;
        }
    ...
    public static ArrayList<Theme> getThemeList(){
        ...
        themeArrayList.add(new Theme(19,R.color.primaryColorEmerald, R.color.primaryDarkColorEmerald, R.color.secondaryColorEmerald));
